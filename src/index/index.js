$(document).ready(function(){
    ...
    $('.home-page-carousel').on('beforeChange', function(event, slick, currentSlide, nextSlide){
        var currentText = $(this).siblings('.carousel-dot-panel').find('.carousel-text-item[data-id=' + currentSlide + ']');
        var nextText = $(this).siblings('.carousel-dot-panel').find('.carousel-text-item[data-id=' + nextSlide + ']');
